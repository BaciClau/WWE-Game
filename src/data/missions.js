...
const MISSIONS = [
    ...
    { id: 'daily_play_10', title: 'Get In The Ring', description: 'Play 10 Exhibition matches', type: 'play_exhibition', target: 10, reward: { coins: 10 }, repeatable: true },
    { id: 'daily_win_5', title: 'Quick Victories', description: 'Win 5 Exhibition matches', type: 'win_exhibition', target: 5, reward: { coins: 10 }, repeatable: true },
    { id: 'daily_win_15', title: 'On A Roll', description: 'Win 15 Exhibition matches', type: 'win_exhibition', target: 15, reward: { coins: 15, picks: 1 }, repeatable: true },
    ...
    { id: 'daily_train_3', title: 'Gym Session', description: 'Train cards 3 times', type: 'train_card', target: 3, reward: { coins: 8 }, repeatable: true },
    { id: 'daily_pcc_3', title: "For The People", description: "Play 3 People's Champion matches", type: 'play_pcc', target: 3, reward: { coins: 12 }, repeatable: true },
    ...
    { id: 'daily_sweep', title: '🧹 DAILY SWEEP', description: 'Claim every other daily mission today', type: 'daily_sweep', target: 1, reward: { coins: 30, picks: 3 }, repeatable: true },

    // --- One-time ---
    { id: 'once_play_1', title: 'First Bell', description: 'Play your first match', type: 'play_exhibition', target: 1, reward: { coins: 10 }, repeatable: false },
    { id: 'once_win_1', title: 'First Blood', description: 'Win your first match', type: 'win_exhibition', target: 1, reward: { coins: 15 }, repeatable: false },
    { id: 'once_collect_10', title: 'Starter Roster', description: 'Collect 60 cards', type: 'collect_cards', target: 60, reward: { coins: 20 }, repeatable: false },
    ...
    { id: 'once_train_1', title: 'Hit The Gym', description: 'Train a card for the first time', type: 'train_card', target: 1, reward: { coins: 10 }, repeatable: false },
    { id: 'once_combine_1', title: 'Level Up', description: 'Combine two duplicate cards for the first time', type: 'combine_card', target: 1, reward: { coins: 20, picks: 1 }, repeatable: false },
    ...
    { id: 'once_win_10', title: 'Ring Veteran', description: 'Win 75 Exhibition matches', type: 'win_exhibition', target: 75, reward: { coins: 30 }, repeatable: false },
    ...
    { id: 'once_play_150', title: 'Ring Regular', description: 'Play 150 Exhibition matches', type: 'play_exhibition', target: 150, reward: { coins: 10 }, repeatable: false },
    ...
    { id: 'once_tier_superrare', title: 'Rising Star', description: 'Reach Super Rare deck tier', type: 'reach_tier', target: 'SuperRare', reward: { coins: 50, picks: 20 }, repeatable: false },
    { id: 'once_tier_ultrarare', title: 'Elite Status', description: 'Reach Ultra Rare deck tier', type: 'reach_tier', target: 'UltraRare', reward: { coins: 100, picks: 30 }, repeatable: false },
    ...
    { id: 'once_tier_legendary', title: 'Legendary Status', description: 'Reach Legendary deck tier', type: 'reach_tier', target: 'Legendary', reward: { coins: 200, card: 'UltraRare', picks: 50 }, repeatable: false },

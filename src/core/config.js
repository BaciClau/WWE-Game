...
const TIERS = [
  ...
  { name: 'Rare+',        base: 'Rare',      min: 1264,  color: '#3498db' },
  { name: 'Rare++',       base: 'Rare',      min: 2527,  color: '#3498db' },
  { name: 'Super Rare',   base: 'SuperRare', min: 3829,  color: '#00bcd4' },
  { name: 'Super Rare+',  base: 'SuperRare', min: 4083,  color: '#00bcd4' },
  { name: 'Super Rare++', base: 'SuperRare', min: 4337,  color: '#00bcd4' },
  { name: 'Ultra Rare',   base: 'UltraRare', min: 4599,  color: '#e040fb' },
  { name: 'Ultra Rare+',  base: 'UltraRare', min: 5024,  color: '#e040fb' },
  { name: 'Ultra Rare++', base: 'UltraRare', min: 5449,  color: '#e040fb' },
  { name: 'Epic',         base: 'Epic',      min: 5887,  color: '#9b59b6' },
  { name: 'Epic+',        base: 'Epic',      min: 6640,  color: '#9b59b6' },
  { name: 'Epic++',       base: 'Epic',      min: 7393,  color: '#9b59b6' },
  { name: 'Legendary',    base: 'Legendary', min: 8169,  color: '#f1c40f' },
  { name: 'Legendary+',   base: 'Legendary', min: 9483,  color: '#f1c40f' },
  { name: 'Legendary++',  base: 'Legendary', min: 10798, color: '#f1c40f' },
  { name: 'Survivor',     base: 'Survivor',  min: 12152, color: '#e74c3c' },
  { name: 'Survivor+',    base: 'Survivor',  min: 13466, color: '#e74c3c' },
  { name: 'Survivor++',   base: 'Survivor',  min: 14781, color: '#e74c3c' },
];
